      ...
      <form   className={styles.loginForm} onSubmit={signup}>
        <div className={styles.boxcol}>
          <div className={styles.column1}>
            <InputField name="fname" type="text" placeholder="First Name" icon="person" />
            <InputField name="lname"type="text" placeholder="Last Name" icon="person" />
            <InputField name="rno" type="text"  placeholder="Roll No." icon="id_card" />
          </div>
          <div className={styles.column2}>
            <InputField name="email" type="email" placeholder="Email Address" icon="mail" />
            <InputField name="pass" type="password" placeholder="New Password" icon="key" />
            <InputField
              type="password"
              placeholder="Retype Password"
              icon="key"
            />
            <InputField name="pin" type="password" placeholder="Wallet pin" icon="key" />
          </div>
        </div>
